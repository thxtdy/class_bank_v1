...
<div class="col-sm-8">
	...
	<form action="/account/withdrawl" method="post">
		...
		<div class="form-group">
			...
			<input type="password" class="form-control" placeholder="Enter Your Password" id="pwd" name="wAccountPassword" value="1234">
		</div>
